...
const ChatBox = ({ currentUser = "volunteer", chatWith = "admin" }) => {
  ...
  return (
    <div className="donor-chat-container">
      <div className="donor-chat-header">💬 Partner Chat with {chatWith}</div>

      <div className="donor-chat-messages">
      ...
      <div className="donor-chat-input">
        <input
          type="text"
          value={newMsg}
        ...
        />
        <button className="donor-chat-sent-btn" onClick={sendMessage}>Send</button>
      </div>
    </div>
  );
};
